...
- STRICT REQUIREMENT: YOU MUST EXCLUSIVELY use Tailwind CSS utility classes for styling. NEVER write plain CSS, SCSS, or use `<style>` blocks under ANY circumstances.
